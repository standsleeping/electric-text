...
def test_convert_with_output_schema():
    """Test conversion of ProviderRequest with output_schema to AnthropicProviderInputs."""
    # The Anthropic converter doesn't currently use output_schema, but the test
